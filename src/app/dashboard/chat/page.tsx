...
import { MessageSquare, Building2, Sparkles } from "lucide-react"
      ...
      <div className="min-h-screen flex items-center justify-center bg-slate-100 dark:bg-slate-900">
        <div className="flex flex-col items-center gap-4">
          <div className="relative">
            ...
            <MessageSquare className="h-8 w-8 text-amber-500 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" />
          </div>
          <p className="text-slate-600 dark:text-slate-400 text-lg font-medium">Loading AI assistant...</p>
        </div>
      </div>
    )
  }
        ...
        <main className="flex-1 container mx-auto py-8 px-4">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-400 mt-1">Get expert advice on your construction project</p>
            </div>
          ...
          {projects.length > 0 && selectedProject ? (
            <Card className="bg-white/80 dark:bg-slate-800/50 backdrop-blur-sm border border-slate-200 dark:border-slate-700 h-[calc(100vh-12rem)]">
              <CardHeader className="pb-3">
                <div className="flex justify-between items-center">
                  <div>
                    <CardTitle>Chat with BuildWise AI</CardTitle>
                    <CardDescription>Ask questions about your project: {selectedProject.name}</CardDescription>
                  </div>
            ...
            <Card className="bg-white/80 dark:bg-slate-800/50 backdrop-blur-sm border border-slate-200 dark:border-slate-700">
              <CardContent className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-slate-500 dark:text-slate-400 text-center mb-6 max-w-md">
                  You need to create a project first to chat with the AI assistant about your construction plans.
                </p>
                <Button
